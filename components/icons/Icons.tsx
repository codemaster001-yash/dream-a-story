...
export const HomeIcon3D: React.FC<{ className?: string }> = ({
  ...
  <IconWrapper className={className}>
    <svg
      ...
      fill="none"
    >
      <rect width="64" height="64" rx="12" fill="#FFE4B5" />
      <path
        d="M32 12L12 30h6v18h12V36h4v12h12V30h6L32 12z"
        fill="#FF6F61"
        stroke="#FFB400"
        strokeWidth="2"
        strokeLinejoin="round"
...
export const BookIcon3D: React.FC<{ className?: string }> = ({
  ...
  <IconWrapper className={className}>
    ...
    >
      ...
      <path
        d="M12 20v24c0 2 2 3 4 2l12-4 12 4c2 1 4 0 4-2V20c0-2-2-3-4-2l-12 4-12-4c-2-1-4 0-4 2z"
        fill="#FFD54F"
        stroke="#4FC3F7"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <line x1="32" y1="22" x2="32" y2="42" stroke="#FFF" strokeWidth="2" />
    </svg>
  </IconWrapper>
);
